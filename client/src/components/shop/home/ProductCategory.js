      ...
      <div className="flex justify-between font-medium">
        <div
          ...
          className={`flex items-center space-x-1 cursor-pointer ${
            data.categoryListDropdown ? "text-green-600" : ""
          }`}
        >
          <span className="text-md md:text-lg hover:text-green-600">
            Categories
          </span>
          <svg
        ...
        <div className="flex space-x-2">
          <div
            ...
            className={`flex items-center space-x-1 cursor-pointer ${
              data.filterListDropdown ? "text-green-600" : ""
            }`}
          >
            <span className="text-md md:text-lg">Filter</span>
            <span>
              <svg
                className="w-4 h-4 text-gray-700 text-green-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            ...
            className={`flex items-center space-x-1 cursor-pointer ${
              data.searchDropdown ? "text-green-600" : ""
            }`}
          >
